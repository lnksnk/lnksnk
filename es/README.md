 ...
 * Sourcemaps.
 * Most of ES6 functionality, still work in progress, see https://github.com/lnksnk/lnksnk/es/milestone/1?closed=1
...
(see https://github.com/lnksnk/lnksnk/es/issues/250 and https://github.com/lnksnk/lnksnk/es/issues/199 for more details).
...
You can find some benchmarks [here](https://github.com/lnksnk/lnksnk/es/issues/2).
...
There is a [separate project](https://github.com/lnksnk/lnksnk/es_nodejs) aimed at providing some NodeJS functionality,
...
for ETAs. Features that are open in the [milestone](https://github.com/lnksnk/lnksnk/es/milestone/1) are either in progress
...
--------------------
Any Go value can be passed to JS using Runtime.ToValue() method. See the method's [documentation](https://pkg.go.dev/github.com/lnksnk/lnksnk/es#Runtime.ToValue) for more details.

Exporting Values from JS
------------------------
A JS value can be exported into its default Go representation using Value.Export() method.

Alternatively it can be exported into a specific Go variable using [Runtime.ExportTo()](https://pkg.go.dev/github.com/lnksnk/lnksnk/es#Runtime.ExportTo) method.
...
- Using [AssertFunction()](https://pkg.go.dev/github.com/lnksnk/lnksnk/es#AssertFunction):
```go
const SCRIPT = `
function sum(a, b) {
    return +a + b;
...
// Output: 42
```
- Using [Runtime.ExportTo()](https://pkg.go.dev/github.com/lnksnk/lnksnk/es#Runtime.ExportTo):
```go
const SCRIPT = `
function sum(a, b) {
    return +a + b;
...
There are two standard mappers: [TagFieldNameMapper](https://pkg.go.dev/github.com/lnksnk/lnksnk/es#TagFieldNameMapper) and
[UncapFieldNameMapper](https://pkg.go.dev/github.com/lnksnk/lnksnk/es#UncapFieldNameMapper), or you can use your own implementation.
...
There is a [separate project](https://github.com/lnksnk/lnksnk/es_nodejs) aimed at providing some of the NodeJS functionality.
